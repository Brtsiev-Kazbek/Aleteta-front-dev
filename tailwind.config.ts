  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        /*
         * Ступени лендинга — отдельные от интерфейсных, и это не небрежность.
         *
         * У маркетинговой страницы другая работа: у неё пять секунд, чтобы
         * объяснить, что это и зачем. Поэтому заголовок там во весь экран, а в
         * приложении такой же был бы издевательством над человеком, который
         * работает в нём восемь часов.
         *
         * Размер плавающий: `clamp` избавляет от четырёх брейкпоинтов на каждый
         * заголовок и от того, что на промежуточной ширине текст выглядит либо
         * растянутым, либо тесным.
         */
        hero: [
          "clamp(2.5rem, 6.2vw, 5rem)",
        ...
        lead: [
          "clamp(1.0625rem, 1.5vw, 1.3125rem)",
