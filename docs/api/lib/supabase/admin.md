[aleteya](../../index.md) / lib/supabase/admin
...
```ts
function createAdminClient(): SupabaseClient<Database, "public", "public", {
  Tables: {
     profiles: {
        Row: ProfileRow;
...
[lib/supabase/admin.ts:18](https://github.com/Brtsiev-Kazbek/Aleteta-front-dev/blob/175322bace04e67fdc0a42e3400fb86a183d27c8/lib/supabase/admin.ts#L18)
