  ...
  return (
    <section className="relative overflow-hidden bg-inverse">
      ...
      <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-32 sm:pt-40 lg:pb-32">
        ...
        >
          Загрузите скан — Алетейя прочитает его и оставит текст в деле. Реквизиты
          объекта живут в одной карточке: заполняются один раз и проверяются по
          форматам, а не набираются заново в каждом документе.
        </motion.p>
