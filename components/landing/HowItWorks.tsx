...
const STEPS = [
  {
    ...
    text: "Скан, фотография, PDF. Хоть на сто девятнадцать страниц — читается волнами, и текст остаётся в поиске по делу.",
    scene: <UploadScene />,
  },
  {
    icon: ScanText,
    title: "Реквизиты — в одной карточке",
    text: "Кадастровый номер, ИНН, адрес, даты. Заполняются один раз и проверяются по форматам: ошибка видна сразу, а не после подачи.",
    scene: <ExtractScene />,
  },
  {
    icon: Sparkles,
