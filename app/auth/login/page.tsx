...
export default function LoginPage({
  ...
  return (
    <AuthShell
      ...
      footnote="Дела, документы и реквизиты принадлежат рабочему пространству, а не аккаунту: когда в команде появится второй человек, переносить ничего не придётся."
    >
      {/*
